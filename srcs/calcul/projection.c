...
// void				projection_iso(t_vect *vertices, t_vect *vert2d, t_viewport *view)
// {
// 	size_t			i;
// 	t_vec3i			v3i;
// 	t_vertex		*v;
...
// 		printf("xbase: %f   xproj: %d   ybase: %f   yproj: %d\n", v->pos.x, v3i.x, v->pos.y, v3i.y);
// 		v3i.z = v->pos.z > 0 ? 0xFFFFFF : 0xFF0000;
// 		i++;
